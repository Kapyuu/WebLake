...
var des_fog = 80
var des_fog_end = 320
var des_color = Color("#080911")
var des_light = 0.12

var rain = false

var default_fog = 80
var default_fog_end = 320
...
func _rain_env(toggle, force = false):
	...
	if toggle:
		...
		des_color = Color("#04050b")
		des_light = 0.06
	
	else :
		des_fog = default_fog
		des_fog_end = default_fog_end
		des_color = Color("#080911")
		des_light = 0.12

func _dist_update():
	default_fog = [80, 60, 40, 20][PlayerData.player_options.view_distance]
	default_fog_end = [320, 220, 110, 85][PlayerData.player_options.view_distance]
	_rain_env(rain, true)
